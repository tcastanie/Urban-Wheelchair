...
public static class varGlobales {
    ...
    public static int prixTravauxGood = 6500;
    public static int prixCorumBad = 0;
    public static int prixCorumGood = 16500;
    ...
    public static string expTerrasseBad = "TERRASSE DE RESTAURANT ENCOMBREE\n\nLe restaurateur a placé ses tables en terrasse sans se soucier des passants utilisant un fauteuil roulant ou une poussette\n\n" + prixTerrasseBad + "€";
